<footer class="pt-4 my-md-5 pt-md-5 border-top">
    <div class="row">
      <div class="col-12 col-md text-center">
        <img class="mb-2 ml-3" src="../assets/img/statistics.svg" alt="" width="80" height="80">
        <small class="d-block mb-3 ml-3 text-muted">&copy; Abid Hasan 2019</small>
      </div>
      ...
      <div class="col-6 col-md">
        ...
        <ul class="list-unstyled text-small">
          ...
          <li><a class="text-muted" href="pricing.htm#">Locations</a></li>
          <li><a class="text-muted" href="pricing.htm#">Privacy</a></li>
          <li><a class="text-muted" href="pricing.htm#">Terms</a></li>
        </ul>
      </div>
    </div>
  </footer>